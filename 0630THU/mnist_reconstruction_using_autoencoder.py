...
def build_autoencoder(x):
  ...
  # 784개의 노드로 구성된 입력층, 각각 256, 128, 256개의 노드를 가진 3개의 은닉층, 784개의 노드를 가진 출력층으로 구성.
...
train_step = tf.train.RMSPropOptimizer(learning_rate).minimize(loss)  # 단순 gradient descent optimizer의 발전된 형태인 RMSPropOptimizer.

...
kp, des = briskF.compute(gray, filtered_kp) # gray에서 특징점 filtered_kp를 이용하여 BRISK 디스크립터 des를 계산. des.dtype=uint8, des.shape=(8,64). 즉, 디스크립터는 8개의 특징점 각각에 대하여 64바이트(512비트).
